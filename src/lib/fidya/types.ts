...
export const FIDYA_WEIGHTS: Record<Madhab, { measure: string; weightKg: number; description: string }> = {
  hanafi: {
    measure: "Half a ṣāʿ of wheat (approximately 1.6 kg), or one ṣāʿ of barley/dates/raisins (~3.2 kg)",
    weightKg: 1.6, // half sa' of wheat
  ...
  hanbali: {
    measure: "One mudd of wheat (~0.51 kg) or half a ṣāʿ of other staples",
    weightKg: 0.51,
